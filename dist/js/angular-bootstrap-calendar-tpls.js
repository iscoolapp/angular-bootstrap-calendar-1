...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    module.exports = factory(require("angular"), require("moment"), (function webpackLoadOptionalExternalModule() {
      try {
    ...
    exports["angularBootstrapCalendarModuleName"] = factory(require("angular"), require("moment"), (function webpackLoadOptionalExternalModule() {
      try {
        return require("interactjs");
      } catch (e) {
      }
...
// timezone tokens
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_0_date_fns_end_of_day__ = __webpack_require__(20);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_1_date_fns_add_minutes__ = __webpack_require__(13);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_2_date_fns_difference_in_days__ = __webpack_require__(17);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_4_date_fns_is_same_day__ = __webpack_require__(25);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_5_date_fns_get_day__ = __webpack_require__(23);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_6_date_fns_start_of_week__ = __webpack_require__(35);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_7_date_fns_add_days__ = __webpack_require__(11);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_8_date_fns_end_of_week__ = __webpack_require__(22);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_9_date_fns_difference_in_seconds__ = __webpack_require__(19);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_10_date_fns_start_of_month__ = __webpack_require__(33);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_11_date_fns_end_of_month__ = __webpack_require__(21);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_12_date_fns_is_same_month__ = __webpack_require__(26);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_13_date_fns_is_same_second__ = __webpack_require__(27);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_14_date_fns_set_hours__ = __webpack_require__(30);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_15_date_fns_set_minutes__ = __webpack_require__(31);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_16_date_fns_start_of_minute__ = __webpack_require__(32);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_17_date_fns_difference_in_minutes__ = __webpack_require__(18);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_18_date_fns_add_hours__ = __webpack_require__(12);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_19_date_fns_add_seconds__ = __webpack_require__(14);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_20_date_fns_min__ = __webpack_require__(29);
      /* harmony import */
      ...
      /* harmony import */
      var __WEBPACK_IMPORTED_MODULE_21_date_fns_max__ = __webpack_require__(28);
      /* harmony import */
      ...
      function getExcludedSeconds(_a) {
        var startDate = _a.startDate, seconds = _a.seconds, excluded = _a.excluded,
          _b = _a.precision, precision = _b === void 0 ? 'days' : _b;
        ...
        switch (precision) {
          ...
          case 'days':
            ...
            result += excluded.filter(function (excludedDay) {
              return excludedDay >= dayStart && excludedDay <= dayEnd;
      ...
      function getWeekViewEventSpan(_a) {
        var event = _a.event, offset = _a.offset, startOfWeekDate = _a.startOfWeekDate,
          excluded = _a.excluded, _b = _a.precision, precision = _b === void 0 ? 'days' : _b;
      ...
      function getWeekViewEventOffset(_a) {
        var event = _a.event, startOfWeek = _a.startOfWeek, _b = _a.excluded,
          excluded = _b === void 0 ? [] : _b, _c = _a.precision,
      ...
      function getWeekViewHeader(_a) {
        var viewDate = _a.viewDate, weekStartsOn = _a.weekStartsOn, _b = _a.excluded,
      ...
      function getWeekView(_a) {
        var _b = _a.events, events = _b === void 0 ? [] : _b, viewDate = _a.viewDate,
          weekStartsOn = _a.weekStartsOn, _c = _a.excluded, excluded = _c === void 0 ? [] : _c,
          _d = _a.precision, precision = _d === void 0 ? 'days' : _d;
        if (!events) {
          events = [];
        }
      ...
      function getDayView(_a) {
        var _b = _a.events, events = _b === void 0 ? [] : _b, viewDate = _a.viewDate,
          hourSegments = _a.hourSegments, dayStart = _a.dayStart, dayEnd = _a.dayEnd,
          eventWidth = _a.eventWidth, segmentHeight = _a.segmentHeight;
        if (!events) {
          events = [];
        }
      ...
      function getDayViewHourGrid(_a) {
        var viewDate = _a.viewDate, hourSegments = _a.hourSegments, dayStart = _a.dayStart,
          dayEnd = _a.dayEnd;
        var hours = [];
        var startOfView = __WEBPACK_IMPORTED_MODULE_15_date_fns_set_minutes___default()(__WEBPACK_IMPORTED_MODULE_14_date_fns_set_hours___default()(__WEBPACK_IMPORTED_MODULE_3_date_fns_start_of_day___default()(viewDate), dayStart.hour), dayStart.minute);
        var endOfView = __WEBPACK_IMPORTED_MODULE_15_date_fns_set_minutes___default()(__WEBPACK_IMPORTED_MODULE_14_date_fns_set_hours___default()(__WEBPACK_IMPORTED_MODULE_16_date_fns_start_of_minute___default()(__WEBPACK_IMPORTED_MODULE_0_date_fns_end_of_day___default()(viewDate)), dayEnd.hour), dayEnd.minute);
...
// removed by extract-text-webpack-plugin
        ...
        .controller('MwlCalendarCtrl', ["$scope", "$log", "$timeout", "$attrs", "$locale", "moment", "calendarTitle", "calendarHelper", function ($scope, $log, $timeout, $attrs, $locale, moment, calendarTitle, calendarHelper) {
          ...
          vm.$onInit = function () {
            ...
            function checkEventIsValid(event) {
              if (!event.startDate) {
                $log.warn(LOG_PREFIX, 'Event is missing the startDate field', event);
              } else if (!angular.isDate(event.startDate)) {
                $log.warn(LOG_PREFIX, 'Event startDate should be a javascript date object. Do `new Date(event.startDate)` to fix it.', event);
              }

              if (event.endDate) {
                if (!angular.isDate(event.endDate)) {
                  $log.warn(LOG_PREFIX, 'Event endDate should be a javascript date object. Do `new Date(event.endDate)` to fix it.', event);
                }
                if (moment(event.startDate).isAfter(moment(event.endDate))) {
      ...
      angular
        ...
        .controller('MwlCalendarDayCtrl', ["$scope", "moment", "calendarHelper", "calendarEventTitle", function ($scope, moment, calendarHelper, calendarEventTitle) {
          ...
          vm.eventDragComplete = function (event, minuteChunksMoved) {
            ...
            var newStart = moment(event.startDate).add(minutesDiff, 'minutes');
            var newEnd = moment(event.endDate).add(minutesDiff, 'minutes');
            delete event.tempStartsAt;

            vm.onEventTimesChanged({
              calendarEvent: event,
              calendarNewEventStart: newStart.toDate(),
              calendarNewEventEnd: event.endDate ? newEnd.toDate() : null
            });
          };

          vm.eventDragged = function (event, minuteChunksMoved) {
            var minutesDiff = minuteChunksMoved * vm.dayViewSplit;
            event.tempStartsAt = moment(event.startDate).add(minutesDiff, 'minutes').toDate();
          };
      ...
      angular
        ...
        .controller('MwlCalendarHourListCtrl', ["$scope", "$document", "moment", "calendarHelper", function ($scope, $document, moment, calendarHelper) {
          ...
          vm.eventDropped = function (event, date) {
            ...
            var newEnd = calendarHelper.adjustEndDateFromStartDiff(event.startDate, newStart, event.endDate);
      ...
      angular
        ...
        .controller('MwlCalendarMonthCtrl', ["$scope", "moment", "calendarHelper", "calendarConfig", "calendarEventTitle", function ($scope, moment, calendarHelper, calendarConfig, calendarEventTitle) {
          ...
          vm.handleEventDrop = function (event, newDayDate, draggedFromDate) {
            ...
            var newStart = moment(event.startDate)
      ...
      angular
        ...
        .controller('MwlCalendarWeekCtrl', ["$scope", "moment", "calendarHelper", "calendarConfig", "calendarEventTitle", function ($scope, moment, calendarHelper, calendarConfig, calendarEventTitle) {
          ...
          vm.weekDragged = function (event, daysDiff, minuteChunksMoved) {
            ...
            var newStart = moment(event.startDate).add(daysDiff, 'days');
            var newEnd = moment(event.endDate).add(daysDiff, 'days');
          ...
          vm.eventDropped = function (event, date) {
            var daysDiff = moment(date).diff(moment(event.startDate), 'days');
          ...
          vm.weekResized = function (event, edge, daysDiff) {
            ...
            var start = moment(event.startDate);
            var end = moment(event.startDate);
            if (edge === 'start') {
      ...
      angular
        ...
        .factory('calendarEventTitle', ["calendarDateFilter", "calendarTruncateEventTitleFilter", function (calendarDateFilter, calendarTruncateEventTitleFilter) {
          ...
          function yearView(event) {
            return event.title + ' (' + calendarDateFilter(event.startDate, 'datetime', true) + ')';
          }

          function monthView(event) {
            return event.title + ' (' + calendarDateFilter(event.startDate, 'time', true) + ')';
          }

          function monthViewTooltip(event) {
            return calendarDateFilter(event.startDate, 'time', true) + ' - ' + event.title;
          }
          ...
          function getYearView(events, viewDate, cellModifier) {
            ...
            while (count < 12) {
              ...
              var cell = {
                ...
                isPastMonth: endPeriod._d < moment()._d
              };
          ...
          function getWeekViewWithTimes(events, viewDate, dayViewStart, dayViewEnd, dayViewSplit) {
            ...
            weekView.days.forEach(function (day) {
              var dayEvents = flattenedEvents.filter(function (event) {
                return moment(event.startDate).startOf('day').isSame(moment(day.date).startOf('day'));
              });
    ...
    /***/ (function (module, exports) {
      ...
      if (typeof __WEBPACK_EXTERNAL_MODULE_72__ === 'undefined') {
